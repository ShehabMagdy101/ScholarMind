...
% Remove "List of Tables" title + vertical space
\renewcommand{\listtablename}{}
\setlength{\cftbeforelottitleskip}{0pt} % remove space before title
\setlength{\cftafterlottitleskip}{0pt}  % remove space after title
\makeatletter
...
{\color{myblue} \rule{\linewidth}{8.0mm}}\vspace{-7.6mm}\noindent
\textbf{ \color{white}\ \Large{#1 #2}}\vspace{6mm}
}

%%% command to create the custom section headers %%%
\newcommand{\SectionTitle}[2]{\noindent \hspace{6mm} {\xhrulefill{blue!25}{8.0mm}}
